...
export default function Greet(props) {
  ...
  const imgUrl =
    'https://www.bcm.edu/sites/default/files/styles/full_width_component_image_standard/public/media/images/galaxy-infinity-milky-way-110854.jpg?h=fb14d4b7&itok=ieuvloD2'
  const divStyle = {
  ...
  return (
    <div>
      <Jumbotron style={divStyle}>
        ...
        <h4>
          Join the conversation below by replying to questions, upvote a few
